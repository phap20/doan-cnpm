...
namespace doan.Admin.Utilities
{
    public class Functions
    {
        public static int _UserAdminID = 0;
        public static string _UserNameAdmin = string.Empty;
        ...
        {
            if (string.IsNullOrEmpty(Functions._UserNameAdmin) || Functions._UserAdminID <= 0)
            {
                return false;
            }
            return true;
